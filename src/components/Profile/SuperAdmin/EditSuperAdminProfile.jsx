import styles from "./EditSuperAdminProfile.module.css";
        ...
        <form onSubmit={handleSubmit}>
          <div className={styles["profile-box"]}>
            <div className={styles.box1}>
              ...
              {isUpdateProfileOpen && (
                <div className={styles["openablebox"]} ref={navigationRef}>
              ...
              <div className={styles.dropdownitem}>
                ...
                <li className={styles.info}>
                  <span className={styles.firstinfos}>
                    <span>
                      <img src={Bell} alt="Personal Information" />
                    </span>
                    ...
                    <label htmlFor="phone">
                      ...
                      <div className={styles.arrowIcon}>
                        <input
                          ...
                          // value={formData.old_phone_number}
